package com.github.shareme.gwsarcanimations;
...
import com.github.shareme.gwsarcanimations.library.ArcAnimator;
import com.github.shareme.gwsarcanimations.library.Side;
...
public class TransitionLoopFragment extends Fragment {
    ...
    void appearBluePair(){
        ...
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.LOLLIPOP) {
            animator = ViewAnimationUtils.createCircularReveal(mBluePair, endBlueX, endBlueY, mBlue.getWidth() / 2f,
                    finalRadius);
        }
    ...
    void appearRed(){
        ...
        Animator animator = null;
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.LOLLIPOP) {
            animator = ViewAnimationUtils.createCircularReveal(mRed, cx, cy, 0, mRed.getWidth() / 2);
        }
        animator.addListener(new SimpleListener(){
            @Override
            public void onAnimationEnd() {
    ...
    void disappearRed(){
        ...
        Animator animator = null;
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.LOLLIPOP) {
            animator = ViewAnimationUtils.createCircularReveal(mRed, cx, cy, mRed.getWidth() / 2, 0);
        }
        animator.addListener(new SimpleListener(){
            @Override
            public void onAnimationEnd() {
    ...
    void disappearBluePair(){
        ...
        Animator animator = null;
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.LOLLIPOP) {
            animator = ViewAnimationUtils.createCircularReveal(mBluePair, endBlueX, endBlueY,
